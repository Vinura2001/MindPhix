...
export default function EditProfile() {
  ...
  return (
    <BaseLayout>
      {user && (
        <div>
          <div className="bg-white rounder-lg pb-5 mt-5 absolute w-3/4 shadow-xl max-h-fit">
            <Image
          ...
          <div className="bg-white shadow-xl absolute pt-5 w-3/4 overflow-hidden top-72">
            <FormProvider {...form}>
